...
export default function CreateClientForm({ handleCreateClient, setIsCreateModalOpen, isCreateModalOpen }) {
        ...
        <Formik
            ...
            onSubmit={async (values, { setSubmitting, setFieldError }) => {
                try {
                    ...
                    await handleCreateClient({ email, password, firstName, lastName, address, phone })
